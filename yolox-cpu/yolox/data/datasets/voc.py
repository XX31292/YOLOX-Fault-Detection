    ...
    def __call__(self, target):
        ...
        for obj in target.iter("object"):
            ...
            if difficult is not None:
                difficult = float(difficult.text) == 1
            else:
                difficult = False
...
class VOCDetection(Dataset):
    ...
    def __init__(
        ...
        self._imgpath_jpg = os.path.join("%s", "JPEGImages", "%s.jpg")
        self._imgpath_png = os.path.join("%s", "JPEGImages", "%s.png")
    ...
    def load_image(self, index):
        img_id = self.ids[index]
        img_path_jpg = self._imgpath_jpg % img_id
        img_path_png = self._imgpath_png % img_id
